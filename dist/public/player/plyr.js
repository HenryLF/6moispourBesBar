...
var require_plyr_min = __commonJS({
  "node_modules/plyr/dist/plyr.min.js"(exports, module2) {
    "object" == typeof navigator && function(e, t) {
      "object" == typeof exports && "undefined" != typeof module2 ? module2.exports = t() : "function" == typeof define && define.amd ? define("Plyr", t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Plyr = t();
    }(exports, function() {
      "use strict";
      function e(e2, t2, i2) {
...
// src/public/player/plyr.ts
var plyr_exports = {};
__export(plyr_exports, {
  initPlayer: () => initPlayer
});
module.exports = __toCommonJS(plyr_exports);
var import_plyr = __toESM(require_plyr_min());
function initPlayer(el, videoId) {
  console.log(el, videoId);
  const player = new import_plyr.default(el.id);
  player.source = {
    type: "video",
    sources: [
      {
  ...
  player.on("ready", () => {
    var _a;
    console.log("ready");
    const parentElement = (_a = document.getElementById(el.id)) == null ? void 0 : _a.parentElement;
    parentElement == null ? void 0 : parentElement.dispatchEvent(
